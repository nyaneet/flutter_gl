...
public class OpenworldGlMacosPlugin: NSObject, FlutterPlugin {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    ...
    let channel = FlutterMethodChannel(name: "openworld_gl", binaryMessenger: messenger as! FlutterBinaryMessenger)
    let instance = OpenworldGlMacosPlugin(textureRegistry: registrar.textures)
