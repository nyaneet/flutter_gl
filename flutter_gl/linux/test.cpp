...
GLuint createRenderTargetTexture(FlutterGlPlugin *self, uint16_t const width, uint16_t const height)
{
    GLuint frameBuffer = 0;
    glGenFramebuffers(1, &frameBuffer);
    glBindFramebuffer(GL_FRAMEBUFFER, frameBuffer);
...
void mainFBO4(FlutterGlPlugin *self, int width, int height) {
    ...
    std::thread gl_thread([](FlutterGlPlugin *self, Shader *shader, int width, int height) {
...
void mainFBO5(FlutterGlPlugin *self, int width, int height) {
    ...
    std::thread gl_thread([](FlutterGlPlugin *self, int width, int height) {
...
void testRandomTexture(FlutterGlPlugin *self, int width, int height) {
