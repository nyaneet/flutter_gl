...
void drawFrame(OpenworldGlPlugin *self) {
...
void main2(OpenworldGlPlugin *self, int width, int height) {
...
// GLFW
// void main3(OpenworldGlPlugin *self, int width, int height) {
//     GLuint shader_program, vbo;
//     GLint pos;
//     GLFWwindow* window;
...
GLuint createRenderTargetTexture(OpenworldGlPlugin *self, uint16_t const width, uint16_t const height)
{
    GLuint frameBuffer = 0;
    glGenFramebuffers(1, &frameBuffer);
    glBindFramebuffer(GL_FRAMEBUFFER, frameBuffer);
...
void mainFBO3(OpenworldGlPlugin *self, int width, int height) {
...
void mainFBO4(OpenworldGlPlugin *self, int width, int height) {

    Shader *shader = new Shader(width, height);
    shader->setShadersText(vertex_shader4, fragment_shader4);
    shader->initShader(self);

    std::thread gl_thread([](OpenworldGlPlugin *self, Shader *shader, int width, int height) {
...
void mainFBO5(OpenworldGlPlugin *self, int width, int height) {

    std::thread gl_thread([](OpenworldGlPlugin *self, int width, int height) {
...
void mainFBO2(OpenworldGlPlugin *self, int width, int height) {
...
void mainFBO(OpenworldGlPlugin *self, int width, int height) {
...
void testRandomTexture(OpenworldGlPlugin *self, int width, int height) {
