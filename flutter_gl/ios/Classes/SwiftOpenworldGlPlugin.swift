...
public class SwiftOpenworldGlPlugin: NSObject, FlutterPlugin {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    ...
    let channel = FlutterMethodChannel(name: "openworld_gl", binaryMessenger: _messenger)
    let instance = SwiftOpenworldGlPlugin(textureRegistry: registrar.textures())
