...
class FlutterGlPlugin : public flutter::Plugin {
 public:
...
// static
void FlutterGlPlugin::RegisterWithRegistrar(
    flutter::PluginRegistrarWindows *registrar) {

  auto plugin = std::make_unique<FlutterGlPlugin>(
...
void FlutterGlPlugin::HandleMethodCall(
    const flutter::MethodCall<flutter::EncodableValue> &method_call,
    std::unique_ptr<flutter::MethodResult<flutter::EncodableValue>> result) {
...
void FlutterGlPluginRegisterWithRegistrar(
    FlutterDesktopPluginRegistrarRef registrar) {
    printf("withregistrar\n");
  FlutterGlPlugin::RegisterWithRegistrar(
